...
def test_meta():
    expected_meta = {
        "name": "Doginal Hub",
        "inscription_icon": "159f5b1437375424ba798c92f10670f19baf3e5d10be3bf5fbd4d4a50c123456i0",
        "supply": "100",
        "slug": "doginal-hub",
        "description": "",
        "twitter_link": "https://twitter.com/doginalhub",
        "discord_link": "https://discord.com/invite/doginalhub",
        "website_link": "",
    }
    current_collections = os.listdir(COLLECTIONS)
    ...
    for x in current_collections:
        ...
        assert len(meta.get('name')) < 30, 'Name is too long'
        assert len(meta.get('slug')) < 28, 'Slug is too long'
